...
export interface CropSquareUploaderProps {
...
export function CropSquareUploader({
  imagePreview,
  hasPendingFile,
  isUploading = false,
  disabled = false,
  ...
  onRemove,
  label = "Foto Produk",
  description = "Upload foto produk (akan di-crop 1:1 dan diupload saat simpan)",
}: CropSquareUploaderProps) {
        ...
        {imagePreview ? (
          <>
            <img
              src={imagePreview}
              alt="Preview"
              className="w-60 aspect-square mx-auto rounded-lg object-cover"
              loading="lazy"
            />
            {hasPendingFile && (
          ...
          <div className="py-10">
            ...
            <p className="text-sm font-medium text-muted-foreground">
              {isUploading
                ? "Mengupload..."
                : "Klik untuk upload foto produk (1:1)"}
            </p>
